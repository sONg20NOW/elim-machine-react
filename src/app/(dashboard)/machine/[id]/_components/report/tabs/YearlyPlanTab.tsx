...
const YearlyPlanTab = forwardRef<refType, { rootCategories?: MachineInspectionRootCategoryResponseDtoType[] }>(
  ({ rootCategories }, ref) => {
    ...
    const DirtyNotice = () => {
      ...
      return !isDirty ? <Typography color='warning.main'>※연도별 계획의 변경사항이 없습니다※</Typography> : null
    }
