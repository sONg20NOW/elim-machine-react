      ...
      const OperationRow = ({
        ...
        return (
          <>
            ...
            <td rowSpan={rowSpan} colSpan={4} style={{ padding: 0, verticalAlign: 'top' }}>
              <StyledTextField sx={{ flex: 1 }} multiline maxRows={rowSpan} {...register(remarkFieldName)} />
            </td>
          </>
        )
      }
              ...
              >
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td rowSpan={10} colSpan={3} style={centerStyle}>
                      열원 및
                      <br />
                      냉난방 설비
                    </td>
