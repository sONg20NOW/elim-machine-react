...
const AgingTab = forwardRef<refType, { rootCategories?: MachineInspectionRootCategoryResponseDtoType[] }>(
  ({ rootCategories }, ref) => {
          ...
          <div className='flex flex-col gap-1 w-full'>
            ...
            >
              ...
              <tbody>
                ...
                <tr>
                  <OperationRow categoryName='신재생(지열)' />
                </tr>
                <tr>
                  <OperationRow categoryName='신재생(태양열)' />
                </tr>
                <tr>
                  <OperationRow categoryName='신재생(연료전지)' />
                </tr>
                <tr>
